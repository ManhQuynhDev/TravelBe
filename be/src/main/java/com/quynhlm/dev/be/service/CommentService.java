...
public class CommentService {
    ...
    public void insertComment(Comment comment, MultipartFile imageFile) throws UnknowException {
        try {
            ...
            if (imageFile != null && !imageFile.isEmpty()) {
                ...
                if (!isValidFileType(imageContentType)) {
                    throw new UnknowException("Invalid file type. Only image files are allowed.");
                }
    ...
    public void updateComment(Integer id, String newContent, MultipartFile imageFile) throws CommentNotFoundException, UnknowException {
